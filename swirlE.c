...
int main() {
    ...
    while (running) {
        ...
        if (corr_factor_avg - 1.10/1.251 > 0) {
        ...
        } else if (corr_factor_avg + 1.10/1.251 < 0) {
            //ch = 7; right servo
            ...
            pulseL = pulseL < 1.5 ? pulseL : 1.5;
            rc_servo_send_pulse_normalized(8, pulseL);
        } else if (corr_factor_avg - 1.0/1.251 > 0) {
            //ch = 7; right servo
            pulseR = r_wheel_gain * (servo_pos * max_speed * 6);
            pulseR = pulseR < 1.5 ? pulseR : 1.5;
            rc_servo_send_pulse_normalized(7, -pulseR);
            ...
            pulseL = pulseL < 1.5 ? pulseL : 1.5;
            rc_servo_send_pulse_normalized(8, pulseL);
        } else if (corr_factor_avg - 0.9/1.251 > 0) {
            //ch = 7; right servo
            pulseR = r_wheel_gain * (servo_pos * max_speed * 6);
            pulseR = pulseR < 1.5 ? pulseR : 1.5;
            rc_servo_send_pulse_normalized(7, -pulseR);
            ...
            pulseL = pulseL < 1.5 ? pulseL : 1.5;
            rc_servo_send_pulse_normalized(8, pulseL);
        } else if (corr_factor_avg - 0.8/1.251 > 0) {
            //ch = 7; right servo
            ...
            pulseL = pulseL < 1.5 ? pulseL : 1.5;
            rc_servo_send_pulse_normalized(8, pulseL);
        } else if (corr_factor_avg - 0.7/1.251 > 0) {
            //ch = 7; right servo
        ...
        else if (corr_factor_avg - 0.60/1.251 > 0) {
            //ch = 7; right servo
        ...
        else if (corr_factor_avg - 0.5/1.251 > 0) {
            //ch = 7; right servo
