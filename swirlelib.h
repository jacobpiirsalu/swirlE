...
{
    if((colour_sensor_red(OUTLeft) + colour_sensor_green(OUTLeft))/2 > (colour_sensor_blue(OUTLeft) + 800 ))
    {
        return true;
    }
    if((colour_sensor_red(OUTRight) + colour_sensor_green(OUTRight))/2 > (colour_sensor_blue(OUTRight) + 800 ))
    {
        return true;
    }
    return false;
