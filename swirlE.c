...
int main() {
    ...
    while (1) {
        ...
        printf("%f\n",corr_factor);
        if (false) {}
        else if (corr_factor - 0.9 > 0) {

            //ch = 7; right servo
            rc_servo_send_pulse_normalized(7, -1*r_wheel_gain * (servo_pos * 0.15*5));
            //printf("R: %f\n", pulse);
            //ch = 8; left servo
            ...
            //ch = 8; left servo
            rc_servo_send_pulse_normalized(8, (servo_pos * 0.15*5));
            //printf("L: %f\n", pulse);

//        } else if (corr_factor - 0.5 > 0) {
//
//            //ch = 7; right servo
//            rc_servo_send_pulse_normalized(7, -1*r_wheel_gain * (servo_pos * 0.15*3));
//            //printf("R: %f\n", pulse);
//            //ch = 8; left servo
//            rc_servo_send_pulse_normalized(8, servo_pos * 0.15);
//        } else if (corr_factor + 0.5 < 0) {
...
//
//            //ch = 8; left servo
//            rc_servo_send_pulse_normalized(8, (servo_pos * 0.15*3));
//            //printf("L: %f\n", pulse);
//        } else if (corr_factor - 0.3 > 0) {
//
//            //ch = 7; right servo
//            rc_servo_send_pulse_normalized(7, -1*r_wheel_gain * (servo_pos * 0.15*2));
//            //printf("R: %f\n", pulse);
//            //ch = 8; left servo
//            rc_servo_send_pulse_normalized(8, servo_pos * 0.15);
//        } else if (corr_factor + 0.3 < 0) {
